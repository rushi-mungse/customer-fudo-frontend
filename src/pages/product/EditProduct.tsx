...
const EditProduct = () => {
    ...
    const { refetch, data } = useQuery({
        ...
        onSuccess: async ({ data }: { data: { product: ProductDataType } }) => {
            setBase64(data.product.imageUrl);
            setAvailability(Boolean(data.product.availability));
        },
    ...
    const { mutate } = useMutation({
        ...
        mutationFn: async (data: FormData) =>
            updateProduct(data, Number(productId)),
                ...
                <Form
                    ...
                    initialValues={{
                        ...
                        preparationTimeInMinute:
                            product.preparationTimeInMinute,
                        price: product.price,
                        size: product.size,
                    }}
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message:
                                            "Enter product preparation time",
                                    },
                                    { type: "number", min: 0 },
                                ]}
                            >
